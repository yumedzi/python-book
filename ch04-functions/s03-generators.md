...
<div><pre style="display:block; white-space: pre-wrap; padding:16px; background-color: #000;color: #e2e2e2;font-family: Hack, Consolas, Menlo, Mono, monospace;border-left: .25em solid #bc0000;">Starting generator...
    First __next__: 0
    Next iteration!
    Second __next__: 1
    Next iteration!
    ...
    Generator is already empty (raised StopIteration)</pre></div>
...
<div><pre style="display:block; white-space: pre-wrap; padding:16px; background-color: #000;color: #e2e2e2;font-family: Hack, Consolas, Menlo, Mono, monospace;border-left: .25em solid #bc0000;"><generator object <genexpr> at 0x7f3e79f23c78>
    2
    4
    6
    8
...
<div><pre style="display:block; white-space: pre-wrap; padding:16px; background-color: #000;color: #e2e2e2;font-family: Hack, Consolas, Menlo, Mono, monospace;border-left: .25em solid #bc0000;"><generator object gen_func at 0x103dcf518>
    2
    4
    6</pre></div>
    8