...
<div><pre style="background-color: #000;color: #e2e2e2;font-family: Hack, Consolas, Menlo, Mono, monospace;border-left: .25em solid #bc0000;"><code>1)
    ...
    We're done with that.</code></pre></div>
...
<div><pre style="background-color: #000;color: #e2e2e2;font-family: Hack, Consolas, Menlo, Mono, monospace;border-left: .25em solid #bc0000;"><code>Enter index: -5</code></pre></div>
...
<div><pre style="background-color: #000;color: #e2e2e2;font-family: Hack, Consolas, Menlo, Mono, monospace;border-left: .25em solid #bc0000;"><code>Oops, can't div by zero!
    ERROR: Can't work with negative numbers
    3.3333333333333335</code></pre></div>
...
<div><pre style="background-color: #000;color: #e2e2e2;font-family: Hack, Consolas, Menlo, Mono, monospace;border-left: .25em solid #bc0000;"><code>OS error: [Errno 2] No such file or directory: '/tmp/1123123.txt'
    /tmp/1123123.txt</code></pre></div>
...
<div><pre style="background-color: #000;color: #e2e2e2;font-family: Hack, Consolas, Menlo, Mono, monospace;border-left: .25em solid #bc0000;"><code>Data or file error: [Errno 2] No such file or directory: 'myfile.txt'</code></pre></div>
