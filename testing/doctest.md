...
Ideally, `doctest`s inform human readers, and tells the computer what to expect at the same time
...
Decorator which adds one test (running function without parameters should produce 0):
